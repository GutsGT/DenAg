                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="content">
                            <div class="content">
                                <br>
                                <form action = "novsenha.html" method = "POST">
                                    <div>
                                        <center>
                                            <h4 style="color:#000"><b><b>Recuperar senha</b></b></h4>
                                        </center>              
                                    </div> 
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-left">
                                                    <div>
                                                        Insira seu email para poder recuperar a senha.
                                                    </div>
                                            </div>
                                            <br>
                                        </div>                                         
                            ...
                            <br> <div class="row">
                                <div class="text-left">
                                    <a style ="color: #a9a9a9" href="login.html">Voltar</a>
                                </div>                             
                            </div>
